      ...
      <div className="grid grid-cols-1 md:grid-cols-[55%_45%] gap-8 items-start">
        ...
        <div className="space-y-5 py-2">
          ...
          <div className="space-y-1.5">
            <p className="font-mono text-[10px] text-forge-dim uppercase tracking-widest">Format</p>
            <div className="flex rounded border border-forge-border overflow-hidden">
              {(["siv", "fni"] as PlateMode[]).map((m) => (
                <button
                  ...
                  className={cn(
                    "flex-1 py-2.5 font-mono text-[10px] uppercase tracking-widest transition-all duration-200",
                    mode === m
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="input-terminal w-full text-center text-xl tracking-[0.3em] uppercase"
              autoComplete="off"
              autoCorrect="off"
              spellCheck={false}
            />
          ...
          {!canContinue && formatted.length > 0 && (
            <p className="text-forge-dim font-mono text-[10px] text-center">
