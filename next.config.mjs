...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Site pré-Shopify (URLs .html encore indexées par Google en 2026-07,
      // relevé via site:plaques-collection.fr — elles tombaient en 404)
      { source: "/moto/plaques-collection-moto-21-x-13.html", destination: "/plaques/moto-21x13", permanent: true },
      { source: "/moto/plaques-collection-moto-17-x-13.html", destination: "/plaques/moto-17x13", permanent: true },
      { source: "/moto/plaques-collection-moto-14-x-13.html", destination: "/plaques/moto-14x13", permanent: true },
      { source: "/moto/plaques-collection-moto-14-x-12.html", destination: "/plaques/moto-14x12", permanent: true },
      { source: "/moto/plaque-collection-12-x-12-cm.html", destination: "/plaques/moto-12x12", permanent: true },
      { source: "/moto/plaques-collection-moto-17-x-17.html", destination: "/plaques/moto-17x17", permanent: true },
      { source: "/moto-sur-1-ligne/plaques-collection-moto-18-x-5-cm.html", destination: "/plaques/moto-18x5", permanent: true },
      { source: "/moto/:path*", destination: "/catalogue?cat=moto", permanent: true },
      { source: "/moto-sur-1-ligne/:path*", destination: "/catalogue?cat=moto", permanent: true },
      { source: "/auto/:path*", destination: "/catalogue?cat=auto", permanent: true },
      // Toute première génération du site (pages .php, relevé Wayback Machine)
      { source: "/plaque-immatriculation-collection-aluminium-auto.php", destination: "/catalogue?cat=auto", permanent: true },
      { source: "/plaque-immatriculation-collection-aluminium-moto.php", destination: "/catalogue?cat=moto", permanent: true },
      { source: "/ancienne-plaque-immatriculation-collection-aluminium-auto.php", destination: "/catalogue?cat=auto", permanent: true },
      { source: "/ancienne-plaque-immatriculation-collection-aluminium-moto.php", destination: "/catalogue?cat=moto", permanent: true },
      { source: "/cgv-plaques-collection.php", destination: "/cgv", permanent: true },
      { source: "/contacter-plaques-collection.php", destination: "/contact", permanent: true },
      { source: "/partenaires-plaques-collection.php", destination: "/", permanent: true },
      { source: "/index.php", destination: "/", permanent: true },
      { source: "/index.html", destination: "/", permanent: true },
      { source: "/panier.php", destination: "/catalogue", permanent: true },
      { source: "/panier", destination: "/catalogue", permanent: true },
